package br.com.tizo.integrationtests.repositories;
...
public class PersonRepositoryTest extends AbstractIntegrationTest {
    ...
    public void testFindByName() throws JsonMappingException, JsonProcessingException {
        ...
        person = repository.findPersonsByName("ath", pageable).getContent().get(0);
        ...
        assertEquals("Risbie", person.getLastName());
        assertEquals("153 Kinsman Street", person.getAddress());
